...
{
    public Bobble[,] GridBobblesPositions = new Bobble[50,50];
    public bool[,] GridBobblesCheck = new bool[50, 50];
    ...
    //{
    //    if (GridBobblesPositions[x, y] == null)
    //        return -1;

    //    if (GridBobblesCheck[x, y] == true)
    //        return -1;
